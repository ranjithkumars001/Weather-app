...
import clear2Icon from './assets/clear2.png'
...
function App() {
  let api_key = '70202abdfaeb26363d9df15912ba03e8';
...
"09n": rainIcon,
 ...
 "13n":snowIcon,
  ...
  setIcon(weatherIconMap [weatherIconCode] || clear2Icon);
  ...
  return (
   ...
   {!loading && !cityNotFound && <WeatherDetails icon={icon} temp={temp} city={city} country={country} lat={lat} log={log}
       ...
       <p className='copyright'>
        Designed by <span>Ranjithkumar</span>
        </p>
      </div>
    </>
  )
